 ...
 */
    [_COLEMAK_DH] = LAYOUT_split_3x6_5_hlc(
     ...
     KC_LSFT , KC_Z ,  KC_X   ,  KC_C  ,   KC_D ,   KC_V , RM_TOGG,RM_NEXT,     FKEYS  , KC_RBRC, KC_K,   KC_H ,KC_COMM, KC_DOT ,KC_SLSH, KC_RSFT,
                                 ADJUST, KC_LGUI,  KC_ESC, KC_SPC , KC_TAB,     KC_ENT    , KC_BSPC ,KC_DEL, KC_RGUI, KC_APP,
